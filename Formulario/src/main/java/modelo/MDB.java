...
public class MDB {
	...
	protected Conexion conexion;
        ...
        conexion = new Conexion("com.mysql.jdbc.Driver","jdbc:mysql://127.0.0.1:3306/ProyectoTortillas","root","");
        ...
        */
        ...
        try {
            ...
            sqlQuery = "SELECT DISTINCT " + campos + " FROM " + table + " WHERE " + condicion;
                        System.out.println("Linea despues de query");
            dataSet = executer.executeQuery(sqlQuery);
                        System.out.println("Linea 92");
            //dataSet.beforeFirst();
                        System.out.println("Linea 93");
                        System.out.println("Ya entró al método antes");
            while(dataSet.next()){
                            System.out.println("Ya entró al método despues");
